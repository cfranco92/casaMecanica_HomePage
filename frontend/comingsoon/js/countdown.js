...
function countdown() {
    ...
    minutes = 23;    
    ctd.innerHTML =
        '<li class="courgette"><div><span class="serif">' + days + '</span><br> day' + (days > 1 ? 's' : '') + '</div></li>' +
        '<li class="courgette"><div><span class="serif">' + hours + '</span><br> hour' + (hours > 1 ? 's' : '') + '</div></li>' +
        '<li class="courgette"><div><span class="serif">' + minutes + '</span><br> minute' + (minutes > 1 ? 's' : '') + '</div></li>' +
        '<li class="courgette"><div><span class="serif">' + seconds + '</span><br> second' + (seconds > 1 ? 's' : '') + '</div></li>';
}
